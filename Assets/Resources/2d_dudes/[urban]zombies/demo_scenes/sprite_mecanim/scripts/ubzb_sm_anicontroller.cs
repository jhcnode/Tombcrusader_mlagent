...
public class ubzb_sm_anicontroller : MonoBehaviour {
	...
	//
	//			ubzb_sm_anicontroller.ani_player("animation name" , "aimation changing time");
	//
	...
	public void change_face (string order)
	{
		if(order == "normal")
		{
			...
			my_anim.Play ("ubzb_sm_faceNormal");
		}
		else if(order == "hurt")
		{
			//change face to hurt face
			my_anim.SetLayerWeight(1,1f);
			my_anim.Play ("ubzb_sm_faceHurt");
		}
		else
		{
			//Stop change face
